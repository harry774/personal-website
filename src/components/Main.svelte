    ...
    <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
        <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Hardik</span> Patel <br/> Full Stack
                <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400"> Favorite Tech </span> includes Javascript (React, SvelteKit), Flutter, Python, Express.js & PostgreSQL!
            </p>
        ...
        <div class="relative shadow-2xl mask-b-from-40% mask-b-to-90% grid place-items-center">
